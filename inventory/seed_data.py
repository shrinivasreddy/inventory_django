...
SIGN_SPEC = {
    ...
    "auto_fields": [f for f in load_seed("AUTO_FIELDS") if f != "LEVEL(R)"] + ["IMAGE_LINK"],
    ...
    "wide_cols": ["STREET_NAME", "SIGN_UID", "WORD_DESCRIPTION", "IMAGE_LINK"],
...
PAVEMENT_SPEC = {
    ...
    "auto_fields": load_seed("PAVEMENT_AUTO_FIELDS") + ["IMAGE_LINK"],
...
LANE_SPEC = {
    ...
    "auto_fields": load_seed("LANE_AUTO_FIELDS") + ["IMAGE_LINK"],
...
CURB_SPEC = {
    ...
    "auto_fields": load_seed("CURB_AUTO_FIELDS") + ["IMAGE_LINK"],
